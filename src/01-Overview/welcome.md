...
Concrete operates [ERC-4626](/glossary/#erc-4626) vaults that accept deposits in a designated underlying asset and deploy that asset into vetted yield strategies. Concrete built the tech stack handles allocation between strategies, real-time accounting updates, and withdrawal processing through automated operator roles. Users interact only with the vault.
...
* **Yield-bearing shares you actually hold** – deposit and you receive [ERC-20](/glossary/#erc-20) vault shares like [ctWBTC](/glossary/#ct-wbtc) or [ctDefiUSDT](/glossary/#ct-defiusdt). Your share count stays constant. Yield generation occurs through an exchange rate as the vault earns.
...
For full risk disclosures see [Risks and Safety](/risks-and-safety/).
