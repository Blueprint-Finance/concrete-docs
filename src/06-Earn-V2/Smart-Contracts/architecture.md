...
This separation is the central design choice. The vault's contract surface is small and follows ERC-4626; variation between products lives in the contracts the vault holds references to: what venues to use, what restrictions to enforce, and how withdrawals settle. A curator launching a new vault is composing modules, not forking a contract.
